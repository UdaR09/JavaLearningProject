...
public class GitWorkFlow {
    public static void main(String[] args) {
        ...
        String step14 = "In case of a commit amend the a git force should be performed in order to update the remote branch and existing Pull Request";
        String step15 = "After that, the origin/master contains  the latest changes and the origin/new_branch can be deleted";
        String step16 = "Don't forget that locally you are still on the new_branch, it's good to move back to master";
        String step17 = "However, the local master branch does not have the lastest changes, therefore perform a git fetch and git pull";
